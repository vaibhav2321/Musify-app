  ...
  return (
    <div className={classes.container}>
        ...
        <div className={classes.secondSection}>
                ...
                <div class={classes.loader}>
                    <div class={classes.song}>
                    <p class={classes.name}>My Way</p>
                    <p class={classes.artist}>Frank Sinatra</p>
                    </div>
                    <div class={classes.albumcover}></div>
                    <div class={classes.play}></div>
                </div>
                <div class={classes.loader}>
                    <div class={classes.song}>
                    <p class={classes.name}>Lemon Tree</p>
                    <p class={classes.artist}>Fools Garden</p>
                    </div>
                    <div class={classes.albumcover}></div>
                    <div class={classes.play}></div>
                </div>
